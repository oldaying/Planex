...
- [Why Four Abstractions](why-four-abstractions.md) — Planex's manifesto
- [Continuous Intent Speculation](continuous-intent-speculation.md) — related speculation about intent gradient
- [Limitations L11](limitations.md) — multi-frame interaction process gap (related to phenomenological school)
- [ADR-0001](../decisions/ADR-0001-perception-currently-noop.md) — Perception gap (related to all four schools)
