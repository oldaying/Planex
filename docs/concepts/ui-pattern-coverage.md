...
- [continuous-intent-speculation.md](continuous-intent-speculation.md) — the theoretical root of Category D's gap
- [Limitations L11](limitations.md) — multi-frame interaction not abstracted
- [ADR-0002](../decisions/ADR-0002-relation-necessity-pending-undo.md) — undo works (Category C pattern 19)
- [ADR-0005](../decisions/ADR-0005-promote-perception-to-fourth-abstraction.md) — Perception handles Category H
