...
Examples:
- `docs/concepts/essence-derivation-v1.md` — "Essence Derivation v1"
- `docs/concepts/essence-derivation-v2.md` — "Essence Derivation v2"
- `docs/concepts/essence-derivation-v3.md` — "Planex Essence Derivation v3 — A First-Principles Audit"
- `docs/concepts/essence-derivation-v4-clean.md` — "Planex Essence Derivation v4 — Clean-Room"
...
- [ADR-0010](../decisions/ADR-0010-v4-design-rationale-not-essence-discovery.md) — formalizes that the v1–v4 essence-derivation lineage is design rationale, not essence discovery
