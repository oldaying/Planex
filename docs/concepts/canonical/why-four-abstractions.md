...
>
> Per [essence-derivation-v2.md](../history/essence-derivation-v2.md), [ADR-0007](../../decisions/accepted/ADR-0007-essence-derivation-v2-revision.md), and [ADR-0008](../../decisions/accepted/ADR-0008-feedback-as-fifth-essence-category.md): Planex implements **5 of 5 essence categories** (Feedback was added in v0.4 as `px_loop`), with 4 additional essence candidates (Embodiment, Situatedness, Affordance-as-relation, Breakdown) deferred as acknowledged.
>
...
- **Acknowledged in**: [limitations.md](../state/limitations.md) L14
...
- A complete UI essence implementation. Per [ui-essence-layers.md](../background/ui-essence-layers.md), Planex implements Layers 1-3 (physical + cognitive + semantic). Layers 4-6 (behavioral + evolutionary + medium) are out of scope. **Within Layers 1-3**, Planex now implements 5 of 5 essence categories (post-v0.4). The 4 deferred essence candidates (Embodiment, Situatedness, Affordance-as-relation, Breakdown) span Layers 2-4 and are not yet implemented.

Planex **is**:

- An experiment in whether Path C (constraint-graph + time-function + speech-act UI + closed-loop coupling) can be made practical, building on 60 years of prior attempts. See [path-C-lineage.md](../background/path-C-lineage.md).
...
- [essence-derivation-v2.md](../history/essence-derivation-v2.md) — the audit that produced the v0.4 framing
- [ADR-0007](../../decisions/accepted/ADR-0007-essence-derivation-v2-revision.md) — records the v2 revision
- [ADR-0008](../../decisions/accepted/ADR-0008-feedback-as-fifth-essence-category.md) — records the Feedback design (v0.4)
- [ADR-0005](../../decisions/accepted/ADR-0005-promote-perception-to-fourth-abstraction.md) — the decision that promoted Perception
- [ADR-0001](../../decisions/superseded/ADR-0001-perception-currently-noop.md) — historical record of the original gap (superseded by ADR-0005)
- [UI Essence Layers](../background/ui-essence-layers.md) — the 6-layer essence model; Planex implements layers 1-3
- [Alternative Perspectives](../background/alternative-perspectives.md) — four academic schools; Planex adopts Cognitive + Mathematical/Linguistic
...
The honest framing, post [v2](../history/essence-derivation-v2.md):
...
**What needs to happen**: A `px_loop` (or similar) type that makes the closed loop explicit, observable, interruptible, replayable. Design TBD — see [essence-derivation-v2.md](../history/essence-derivation-v2.md) Step 2. **Not yet implemented.**
...
- **Why deferred**: requires giving up "UI as independent artefact" premise, which is foundational to Planex's current API (Estimates, Closures, Perceptions all exist independently of actor)
- **Acknowledged in**: [limitations.md](../state/limitations.md)
...
- An experiment in whether Path C (constraint-graph + time-function + speech-act UI) can be made practical, building on 60 years of prior attempts. See [path-C-lineage.md](../background/path-C-lineage.md).
- An honest essence-driven project: the claim matches the implementation, including its gaps and deferrals.
...
- [essence-derivation-v2.md](../history/essence-derivation-v2.md) — the audit that produced this revision
- [essence-derivation-v1.md](../history/essence-derivation-v1.md) — v1 derivation (superseded by v2; kept for history)
- [ADR-0005](../../decisions/accepted/ADR-0005-promote-perception-to-fourth-abstraction.md) — the decision that promoted Perception
- [ADR-0007](../../decisions/accepted/ADR-0007-essence-derivation-v2-revision.md) — records the v2 revision
- [ADR-0001](../../decisions/superseded/ADR-0001-perception-currently-noop.md) — historical record of the original gap (superseded by ADR-0005)
- [UI Essence Layers](../background/ui-essence-layers.md) — the 6-layer essence model; Planex implements layers 1-3
