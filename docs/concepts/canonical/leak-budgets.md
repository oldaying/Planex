...
>
> **Companion documents:**
> - [`limitations.md`](../state/limitations.md) — qualitative gaps (L1–L14). This document's leak categories cross-reference those where applicable.
...
> - [`../decisions/ADR-0011-essence-justified-abstraction-exempts-rule-of-three.md`](../../decisions/accepted/ADR-0011-essence-justified-abstraction-exempts-rule-of-three.md) — Essence Check Q4 establishes the pattern that "every claim must have a verifiable cost scenario"; this document applies that pattern to leaks.
> - [`../decisions/ADR-0013-v05-leak-budget-retire.md`](../../decisions/accepted/ADR-0013-v05-leak-budget-retire.md) — documents the v0.5 retire landing (mechanism, verification, residual leaks).
...
This section documents what was actually done in the v0.5 retire. It is referenced from [`ADR-0013`](../../decisions/accepted/ADR-0013-v05-leak-budget-retire.md).
...
- **Not a substitute for [`limitations.md`](../state/limitations.md).** Limitations is qualitative (gaps L1–L14); this document is quantitative (leak counts per abstraction). Both are needed; this document cross-references Limitations where the same gap appears in both (e.g., L1 Phase 2 ↔ Perception L2 = 50%).
...
2. Read [`../decisions/ADR-0011-essence-justified-abstraction-exempts-rule-of-three.md`](../../decisions/accepted/ADR-0011-essence-justified-abstraction-exempts-rule-of-three.md) for the Rule-of-Three rebuttal.
...
- **Related docs:** [`limitations.md`](../state/limitations.md) — qualitative gaps (L1–L14). Cross-referenced where the same gap appears in both.
...
- **Related ADRs:** [ADR-0010](../../decisions/accepted/ADR-0010-v4-design-rationale-not-essence-discovery.md) — the honesty downgrade this document extends; [ADR-0011](../../decisions/accepted/ADR-0011-essence-justified-abstraction-exempts-rule-of-three.md) — Essence Check Q4 establishes the verifiable-cost-scenario pattern this document applies to leaks; [ADR-0012](../../decisions/accepted/ADR-0012-v4-orthogonality-pressure-test-four-findings.md) — the v4 pressure test whose findings the v4 preview section above quantifies.
