...
For term definitions, see [Glossary](glossary.md). For API specifics, see [API Reference](../reference/api.md). For design rationale, see [Why Four Abstractions](why-four-abstractions.md) and the [ADR index](../decisions/README.md).
...
**See:** [ADR-0002](../decisions/ADR-0002-relation-necessity-pending-undo.md)
...
**Notable:** Stage 5 (Perception) is currently a no-op — see [ADR-0001](../decisions/ADR-0001-perception-currently-noop.md)
...
- [Why Four Abstractions](why-four-abstractions.md) — design rationale
