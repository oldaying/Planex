...
**ADR:** [ADR-0003](../decisions/ADR-0003-no-ai-integration.md)
...
Planex does not ship a "components" directory with `Button`, `Input`, `Select`, `Modal`, etc. The thesis is that widgets **emerge** from the four abstractions — see `docs/concepts/why-four-abstractions.md`.
