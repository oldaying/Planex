...
[essence-derivation-v3.md](../concepts/essence-derivation-v3.md)
...
[essence-derivation-v2.md](../concepts/essence-derivation-v2.md)
...
- [ui-essence-layers.md](../concepts/ui-essence-layers.md) —
  Layer 4 (Behavioral — Zuhandenheit) now has first-class
  primitives (WITHDRAWS_FOR / PRESENTS_FOR / px_breakdown)
- [non-goals.md](../concepts/non-goals.md) NG-3 (no kitchen-sink
  API — Path B respects by keeping actor as struct, not abstraction)
- [limitations.md](../concepts/limitations.md) L2 (Situatedness
  gap — closed by 3-place Relation + px_actor)
- [limitations.md](../concepts/limitations.md) L3 (anti-pattern
...
- [ADR-0003](ADR-0003-no-ai-integration.md) — unchanged. Path B's
...
- [path-C-lineage.md](../concepts/path-C-lineage.md) — must be
