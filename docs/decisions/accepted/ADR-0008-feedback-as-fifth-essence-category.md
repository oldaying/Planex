...
Per [essence-derivation-v2.md](../../concepts/history/essence-derivation-v2.md) and ADR-0007, Feedback / closed-loop coupling was identified as a 5th essence category — distinct from State / Communication / Presentation / Relational ontology. ADR-0007 acknowledged the gap but did not close it. This ADR closes it.
