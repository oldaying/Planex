...
[essence-derivation-v4-clean.md](../concepts/essence-derivation-v4-clean.md)
...
- `docs/concepts/essence-derivation-v4-clean.md` — Part VII
  (audit) and Appendix (honest framing) already reflect this
  ADR's conclusion. No change required.
- `docs/concepts/essence-derivation-v3.md` — predates this ADR;
...
- `docs/concepts/why-four-abstractions.md` — uses the older "4
...
- `README.md` (repo root) — must be updated separately to use
  ...
  that update.
- `docs/concepts/limitations.md`, `docs/concepts/non-goals.md`,
  `docs/concepts/ui-essence-layers.md`, `docs/concepts/path-C-lineage.md`
...
- [ADR-0009](ADR-0009-essence-rederivation-v3.md) — v3 Path B
...
- [ADR-0005](ADR-0005-promote-perception-to-fourth-abstraction.md)
  ...
  scope).
- [ADR-0009](ADR-0009-essence-rederivation-v3.md) — the ADR most
...
- [non-goals.md](../concepts/non-goals.md) — the project's
...
- [why-four-abstractions.md](../concepts/why-four-abstractions.md)
